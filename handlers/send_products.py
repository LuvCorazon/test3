...
async def start_send_products(message: types.Message):
    ...
    button_all = types.InlineKeyboardButton('Вывести все товары', callback_data='all_products')
    button_one = types.InlineKeyboardButton('Вывести по одному', callback_data='one_products')
...
def register_handlers(dp: Dispatcher):
    ...
    dp.register_callback_query_handler(send_all_products, Text(equals='all_products'))
